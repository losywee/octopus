                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-0.5 opacity-0 group-hover/preset:opacity-100 transition-opacity">
                                            <MorphingDialog key={`preset-edit-${preset.id}`}>
                                                ...
                                                />
                                                <MorphingDialogContainer>
                                                    <MorphingDialogContent className="relative w-screen max-w-full md:max-w-4xl bg-card text-card-foreground px-6 py-4 rounded-3xl h-[calc(100dvh-2rem)] flex flex-col overflow-hidden">
